...
public class HlsVideoUtil extends VideoUtil {
    ...
    String ffmpeg_path = "E:\\java\\develop\\ffmpeg\\ffmpeg-20180227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";//ffmpeg的安装位置
    String video_path = "F:\\project\\xcEdu\\video\\java.avi";
    String m3u8_name = "java.m3u8";
    String m3u8folder_path = "F:\\project\\xcEdu\\video\\";
...
//        commend.add("D:/BaiduNetdiskDownload/Movies/test1/test1.m3u8");
        ...
        sourceList.add(video_path);
        List<String> targetList = new ArrayList<>();
        File folderFile = new File(m3u8folder_path);
        ...
        for (File file : files) {
            targetList.add(m3u8folder_path+file.getName());
        }

        //Boolean check_video_time = check_video_time(sourceList, targetList);
//        Boolean check_video_time = check_video_size(sourceList, targetList);
//        if (!check_video_time) {
//            return outstring;
//        }
        //通过查看m3u8列表判断是否成功
...
//            fileList.add(hls_relativepath+m3u8_name);
    ...
    public static void main(String[] args) throws IOException {
        String ffmpeg_path = "E:\\java\\develop\\ffmpeg\\ffmpeg-20180227-fa0c9d6-win64-static\\bin\\ffmpeg.exe";//ffmpeg的安装位置
        String video_path = "F:\\project\\xcEdu\\video\\9\\e\\9e4520260a843a7822cfde35feff5065\\9e4520260a843a7822cfde35feff5065.mp4";
        String m3u8_name = "java.m3u8";
        String m3u8_path = "F:\\project\\xcEdu\\video\\9\\e\\9e4520260a843a7822cfde35feff5065\\hls\\";
